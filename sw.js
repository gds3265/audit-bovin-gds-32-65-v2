const CACHE = 'audit-bovin-pwa-v14.6.21.29';
const ASSETS = [
  './?v=14.6.21.29','./index.html?v=14.6.21.29','./styles.css?v=14.6.21.29','./app.js?v=14.6.21.29','./cloud-sync.js?v=14.6.21.29',
  './analysis-rules.js','./knowledge-base.js','./storage.js','./utils.js','./manifest.webmanifest?v=14.6.21.29',
  './icon-192.png?v=14.6.21.29','./icon-512.png?v=14.6.21.29','./planches-visuelles.png','./jszip.min.js?v=14.6.21.29',
  './modele-partenaires-passage-bv.xlsx?v=14.6.21.29','./questionnaire.html?v=14.6.21.29','./questionnaire.js?v=14.6.21.29','./questionnaire.css?v=14.6.21.29',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async()=>{
    try{
      ...
      if(req.mode==='navigate')return (await caches.match('./index.html?v=14.6.21.29'))||(await caches.match('./?v=14.6.21.29'))||(await caches.match('./index.html'));
