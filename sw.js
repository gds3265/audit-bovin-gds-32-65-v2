const CACHE = 'audit-bovin-pwa-v14.6.21.71';
const ASSETS = [
  './?v=14.6.21.71','./index.html?v=14.6.21.71','./styles.css?v=14.6.21.71','./app.js?v=14.6.21.71','./cloud-sync.js?v=14.6.21.71',
  './analysis-rules.js','./knowledge-base.js','./storage.js','./utils.js','./manifest.webmanifest?v=14.6.21.71',
  './icon-192.png?v=14.6.21.71','./icon-512.png?v=14.6.21.71','./planches-visuelles.png','./jszip.min.js?v=14.6.21.71',
  './modele-partenaires-passage-bv.xlsx?v=14.6.21.71','./questionnaire.html?v=14.6.21.71','./questionnaire.js?v=14.6.21.71','./questionnaire.css?v=14.6.21.71',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async()=>{
    try{
      ...
      if(req.mode==='navigate')return (await caches.match('./index.html?v=14.6.21.71'))||(await caches.match('./?v=14.6.21.71'))||(await caches.match('./index.html'));
