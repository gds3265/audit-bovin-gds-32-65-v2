...
const ASSETS = [
  ...
  './icon-192.png?v=14.6.21.41','./icon-512.png?v=14.6.21.41','./planches-visuelles.png','./jszip.min.js?v=14.6.21.41',
  './modele-partenaires-passage-bv.xlsx?v=14.6.21.41','./questionnaire.html?v=14.6.21.41','./questionnaire.js?v=14.6.21.41','./questionnaire.css?v=14.6.21.41',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async()=>{
    try{
      ...
      if(req.mode==='navigate')return (await caches.match('./index.html?v=14.6.21.41'))||(await caches.match('./?v=14.6.21.41'))||(await caches.match('./index.html'));
