const CACHE = 'audit-bovin-pwa-v14.6.21.122';
const ASSETS = [
  './?v=14.6.21.122','./index.html?v=14.6.21.122','./styles.css?v=14.6.21.122','./app.js?v=14.6.21.122','./cloud-sync.js?v=14.6.21.122',
  './analysis-rules.js','./knowledge-base.js','./storage.js','./utils.js','./manifest.webmanifest?v=14.6.21.122',
  './icon-192.png?v=14.6.21.122','./icon-512.png?v=14.6.21.122','./planches-visuelles.png','./jszip.min.js?v=14.6.21.122',
  './modele-partenaires-passage-bv.xlsx?v=14.6.21.122','./MODELE_IMPORT_CHATGPT.csv?v=14.6.21.122','./questionnaire.html?v=14.6.21.122','./questionnaire.js?v=14.6.21.122','./questionnaire.css?v=14.6.21.122',
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async()=>{
    try{
      ...
      if(req.mode==='navigate')return (await caches.match('./index.html?v=14.6.21.122'))||(await caches.match('./?v=14.6.21.122'))||(await caches.match('./index.html'));
