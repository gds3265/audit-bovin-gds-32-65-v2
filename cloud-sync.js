...
function openCloudPanel(){
  ...
  overlay.innerHTML=`<div class="cloud-panel"><div class="cloud-panel-head"><div><strong>Base commune techniciens</strong><small>v14.6.14 sécurisée</small></div><button type="button" data-cloud-close>×</button></div>${body}</div>`;
