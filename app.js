...
const libraryPdfCatalog = [
  {groups:['protocoles'],kind:'Fiche thématique',title:'Approche globale & protocole',file:'library-pdfs/theme-approche-globale.pdf',thumb:'library-thumbs/theme-approche-globale.jpg',note:'Repères + visuels/mémo terrain.'},
  {groups:['animaux'],kind:'Fiche thématique',title:'Observation du troupeau & températures',file:'library-pdfs/theme-observation-troupeau.pdf',thumb:'library-thumbs/theme-observation-troupeau.jpg',note:'Observation adultes/veaux et repères de température.'},
  {groups:['animaux'],kind:'Fiche thématique',title:'Urines',file:'library-pdfs/theme-urines.pdf',thumb:'library-thumbs/theme-urines.jpg',note:'pH, densité, Brix, Redox et mémo terrain.'},
  {groups:['sang'],kind:'Fiche thématique',title:'Sang',file:'library-pdfs/theme-sang.pdf',thumb:'library-thumbs/theme-sang.jpg',note:'Glycémie, BOH et interprétation rapide.'},
  {groups:['fourrages'],kind:'Fiche thématique',title:'Fèces & digestion',file:'library-pdfs/theme-feces-digestion.pdf',thumb:'library-thumbs/theme-feces-digestion.jpg',note:'Observation, pH/Redox et tamisage.'},
  {groups:['eau','courants'],kind:'Fiche thématique',title:'Eau, abreuvement & courants parasites',file:'library-pdfs/theme-eau-abreuvement.pdf',thumb:'library-thumbs/theme-eau-abreuvement.jpg',note:'Eau, abreuvement et contrôle des tensions parasites.'},
  {groups:['colostrum'],kind:'Fiche thématique',title:'Lait, colostrum & veaux',file:'library-pdfs/theme-lait-colostrum-veaux.pdf',thumb:'library-thumbs/theme-lait-colostrum-veaux.jpg',note:'Colostrum, transfert et conduite des veaux.'},
  {groups:['sol-plantes'],kind:'Fiche thématique',title:'Sol',file:'library-pdfs/theme-sol.pdf',thumb:'library-thumbs/theme-sol.jpg',note:'Repères et mesures du sol.'},
  {groups:['sol-plantes'],kind:'Fiche thématique',title:'Plantes, pâturage & herbe',file:'library-pdfs/theme-plantes-paturage.pdf',thumb:'library-thumbs/theme-plantes-paturage.jpg',note:'Repères plante/herbe et contexte de prélèvement.'},
  {groups:['fourrages','nutrition'],kind:'Fiche thématique',title:'Fourrages & alimentation',file:'library-pdfs/theme-fourrages-alimentation.pdf',thumb:'library-thumbs/theme-fourrages-alimentation.jpg',note:'Fourrages, ration et interprétation terrain.'},
  {groups:['protocoles','appareils'],kind:'Fiche thématique',title:'Outils, étalonnage & prélèvements',file:'library-pdfs/theme-outils-prelevements.pdf',thumb:'library-thumbs/theme-outils-prelevements.jpg',note:'Bonnes pratiques de mesure et prélèvement.'},
  {groups:['environnement'],kind:'Fiche thématique',title:'Litière & environnement',file:'library-pdfs/theme-litiere-environnement.pdf',thumb:'library-thumbs/theme-litiere-environnement.jpg',note:'Litière, ambiance et environnement.'},

  {groups:['appareils'],kind:'Mode d’emploi',title:'LAQUAtwin 4M',file:'library-pdfs/outil-laquatwin-4m.pdf',thumb:'library-thumbs/outil-laquatwin-4m.jpg',note:'K+, Ca2+, NO3- et Na+.'},
  {groups:['appareils','sang'],kind:'Mode d’emploi',title:'LYSUN RFM101 - Urée',file:'library-pdfs/outil-lysun-uree.pdf',thumb:'library-thumbs/outil-lysun-uree.jpg',note:'Utilisation et interprétation rapide.'},
  {groups:['appareils','eau'],kind:'Mode d’emploi',title:'CONTROL TH - Dureté de l’eau',file:'library-pdfs/outil-control-th.pdf',thumb:'library-thumbs/outil-control-th.jpg',note:'Mesure de dureté de l’eau.'},
  {groups:['appareils','eau'],kind:'Mode d’emploi',title:'HANNA HI701 - Chlore libre',file:'library-pdfs/outil-hanna-hi701.pdf',thumb:'library-thumbs/outil-hanna-hi701.jpg',note:'Mesure du chlore libre.'},
  {groups:['appareils','sang'],kind:'Mode d’emploi',title:'FreeStyle Optium Neo H - Glycémie / BOH',file:'library-pdfs/outil-freestyle-optium.pdf',thumb:'library-thumbs/outil-freestyle-optium.jpg',note:'Glycémie, BOH et codes/lecture terrain.'},
  {groups:['appareils','eau','sol-plantes'],kind:'Mode d’emploi',title:'APERA PH5F - pH',file:'library-pdfs/outil-apera-ph5f.pdf',thumb:'library-thumbs/outil-apera-ph5f.jpg',note:'Mesure du pH et entretien.'},
  {groups:['appareils','eau','sol-plantes'],kind:'Mode d’emploi',title:'EXTECH PH100 ExStik - pH',file:'library-pdfs/outil-extech-ph100.pdf',thumb:'library-thumbs/outil-extech-ph100.jpg',note:'Mesure du pH et entretien.'},
  {groups:['appareils','eau','sol-plantes'],kind:'Mode d’emploi',title:'EXTECH RE300 ExStik - ORP / Redox',file:'library-pdfs/outil-extech-re300.pdf',thumb:'library-thumbs/outil-extech-re300.jpg',note:'ORP/Redox : utilisation terrain.'},
  {groups:['appareils','courants'],kind:'Mode d’emploi',title:'Multimètre - Tensions parasites',file:'library-pdfs/outil-multimetre.pdf',thumb:'library-thumbs/outil-multimetre.jpg',note:'Mesure des courants/tensions parasites en élevage.'}
];
function libraryPdfCardsHtml(groupId){
  const items=libraryPdfCatalog.filter(x=>x.groups.includes(groupId));
  if(!items.length)return '';
  return `<section class="card library-pdf-section"><div class="section-title"><div><h3>📚 Fiches pratiques du thème</h3><div class="muted">Fiches GDS 32-65 intégrées à l’application et disponibles hors ligne.</div></div><span class="badge autosave">${items.length} fiche(s)</span></div><div class="library-pdf-grid">${items.map(x=>`<article class="library-pdf-card"><img src="${x.thumb}" alt="Aperçu ${escapeHtml(x.title)}"><div><span class="library-pdf-kind">${escapeHtml(x.kind)}</span><h4>${escapeHtml(x.title)}</h4><p>${escapeHtml(x.note)}</p><a class="btn small" href="${x.file}" target="_blank" rel="noopener">Ouvrir la fiche PDF</a></div></article>`).join('')}</div></section>`;
}
...
function renderPlanches() {
  ...
  app.innerHTML = `<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Repères visuels, fiches pratiques et carnet technique, disponibles hors ligne.</div></div><span class="badge autosave">v14.6.20</span></div>
...
function renderJournalSuivi(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📒 Journal & points de vigilance</h2><div class="muted">Noter les nouvelles reçues entre deux visites, les difficultés et les événements sanitaires.</div></div><span class="badge autosave">v14.6.20</span></div>
...
function renderVisits() {
  ...
  app.innerHTML = `
    <div class="section-title"><div><h2>Visites</h2><div class="muted">Toutes les visites enregistrées restent accessibles, y compris les plus anciennes.</div></div><span class="badge autosave">v14.6.20</span></div>
...
function renderPilotageActions(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>🎯 Pilotage des actions</h2><div class="muted">Vue commune de toutes les actions décidées lors des visites.</div></div><span class="badge autosave">v14.6.20</span></div>
...
function renderNutritionAnalysis(){
  const visit=activeVisit();
  if(!visit){app.innerHTML=`<div class="section-title"><div><h2>Analyse nutritionnelle</h2><div class="muted">Interprétation simple des analyses de fourrage et de ration.</div></div><span class="badge autosave">v14.6.20</span></div><section class="empty">Choisissez une visite dans l’onglet Visites.</section>`;return;}
...
function renderFollowup(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Historique & évolution</h2><div class="muted">Comparer deux visites d’une même exploitation : reproduction, mortalité, mesures, alimentation, bâtiment et plans d’action.</div></div><span class="badge autosave">v14.6.20</span></div>
