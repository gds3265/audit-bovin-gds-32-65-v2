...
function renderPlanches() {
  ...
  app.innerHTML = `<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Repères visuels, fiches pratiques et carnet technique, disponibles hors ligne.</div></div><span class="badge autosave">v14.6.21.28</span></div>
...
function renderJournalSuivi(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📒 Journal & points de vigilance</h2><div class="muted">Noter les nouvelles reçues entre deux visites, les difficultés et les événements sanitaires.</div></div><span class="badge autosave">v14.6.21.28</span></div>
...
function renderVisits() {
  ...
  app.innerHTML = `
    <div class="section-title"><div><h2>Visites</h2><div class="muted">Toutes les visites enregistrées restent accessibles, y compris les plus anciennes.</div></div><span class="badge autosave">v14.6.21.28</span></div>
...
function renderFarmerQuestionnaires(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📨 Questionnaires éleveur</h2><div class="muted">Préparer la visite puis récupérer uniquement les réponses encore manquantes.</div></div><span class="badge autosave">v14.6.21.28</span></div>${activeVisitBanner(visit)}
...
function ensureReferenceSettings(){db.settings=db.settings&&typeof db.settings==='object'?db.settings:{};db.settings.referenceThresholdOverrides=db.settings.referenceThresholdOverrides&&typeof db.settings.referenceThresholdOverrides==='object'?db.settings.referenceThresholdOverrides:{};db.settings.metabolicLabs=Array.isArray(db.settings.metabolicLabs)?db.settings.metabolicLabs:[];return db.settings;}
...
function renderPilotageActions(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>🎯 Pilotage des actions</h2><div class="muted">Vue commune de toutes les actions décidées lors des visites.</div></div><span class="badge autosave">v14.6.21.28</span></div>
...
function renderNutritionAnalysis(){
  const visit=activeVisit();
  if(!visit){app.innerHTML=`<div class="section-title"><div><h2>Analyse nutritionnelle</h2><div class="muted">Interprétation simple des analyses de fourrage et de ration.</div></div><span class="badge autosave">v14.6.21.28</span></div><section class="empty">Choisissez une visite dans l’onglet Visites.</section>`;return;}
...
function renderFollowup(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Historique & évolution</h2><div class="muted">Comparer deux visites d’une même exploitation : reproduction, mortalité, mesures, alimentation, bâtiment et plans d’action.</div></div><span class="badge autosave">v14.6.21.28</span></div>
...
// V14.6.21.28 — Profil métabolique & parasitisme
const METABOLIC_KNOWLEDGE={
  ...
  cobalt:{label:'Cobalt / Vitamine B12',aliases:['cobalt','co','b12','vitamine b12'],impacts:['Synthèse ruminale de vitamine B12','Appétit et croissance','Métabolisme énergétique','État général'],checks:['Apport cobalt du minéral','Qualité / origine des fourrages','Croissance et NEC','B12 si disponible'],corrections:['Revoir la couverture en cobalt et la distribution minérale','Croiser avec ration et performances','Valider la correction avec nutritionniste / vétérinaire'],caution:'Chez le ruminant, le cobalt conditionne la synthèse microbienne de vitamine B12.'},
...
function metabolicPaperPreset(m,preset='essential'){
 const essential=['Cuivre (Cu)','Sélénium (Se)','Zinc (Zn)','Iode (I)','Cobalt / Vitamine B12','Manganèse (Mn)','Fer (Fe)','Vitamine A','Vitamine E'];
...
if ('serviceWorker' in navigator){
  ...
  const AUDIT_SW=location.origin+AUDIT_PATH+'sw.js?v=14.6.21.28';
