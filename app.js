...
let activeLibraryTheme = localStorage.getItem('audit-bovin-library-theme') || 'all';
let librarySearch = '';
...
const libraryGroups = [
  { id:'animal', label:'Mesures animales', icon:'🐄', themes:['Urines','Sang','Bouses','Tamis','Lait','Colostrum','Observations physiques'] },
  { id:'general', label:'Mesures générales', icon:'🌱', themes:['Silos','Sol','Plantes','Eau'] },
  { id:'building', label:'Bâtiment', icon:'🏠', themes:['Abreuvoirs','Électricité','Litière','Ambiance','Plan bâtiment'] },
  { id:'tools', label:'Outils et protocoles', icon:'🧰', themes:['Prélèvements','Étalonnage','Réfractomètre','pH-mètre','Laquatwin','Lecteur glycémie/BOH'] },
  { id:'audit', label:'Audit et conduite', icon:'📋', themes:['Alimentation','Fourrages','Audit global','Méthode 5mVet'] }
];

const libraryEntries = [
  {id:'urines-protocole',theme:'Urines',title:'Prélèvement et mesure des urines',tags:['urine','prélèvement','pH','redox','brix','densité'],summary:'Prélever rapidement, homogénéiser si nécessaire et mesurer dans des conditions comparables.',sections:[['Avant de mesurer',['Identifier le sujet et la catégorie si elle est connue.','Utiliser un récipient propre et sec.','Éviter un prélèvement souillé par la litière ou les bouses.']],['Ordre conseillé',['Noter la couleur de 1 à 5.','Mesurer pH et redox sans attendre.','Mesurer ensuite Brix et densité.']],['Vigilances',['Rincer et sécher les sondes entre deux animaux.','Ne pas interpréter selon une catégorie tant que le sujet n’est pas classé.']]]},
  {id:'urines-lecture',theme:'Urines',title:'Lecture rapide des résultats urinaires',tags:['couleur','pH','redox','brix','densité','interprétation'],summary:'Les résultats se lisent par catégorie et doivent être croisés avec le sang, les bouses, la ration et l’accès à l’eau.',sections:[['À regarder ensemble',['Couleur et concentration.','pH et redox.','Brix et densité.']],['Interprétation',['Une valeur isolée ne suffit pas.','Regarder la dispersion du lot : minimum, moyenne et maximum.','Rechercher les concordances avec les observations physiques et alimentaires.']]],visual:true},
  {id:'sang-lecteur',theme:'Sang',title:'Prélèvement et lecteur glycémie / BOH',tags:['sang','glycémie','boh','lecteur','bandelette'],summary:'Préparer le lecteur, vérifier les bandelettes et déposer une goutte suffisante sans délai.',sections:[['Préparation',['Vérifier la date de péremption des bandelettes.','Utiliser le bon type de bandelette et le bon code si l’appareil le demande.','Garder le lecteur et les bandelettes à température compatible.']],['Mesure',['Prélever proprement.','Appliquer la goutte comme indiqué par le fabricant.','Noter immédiatement la valeur et l’unité.']],['Erreurs fréquentes',['Goutte insuffisante.','Bandelette trop froide ou humide.','Confusion entre unités ou type de bandelette.']]]},
  {id:'sang-interpretation',theme:'Sang',title:'Repères d’interprétation du sang',tags:['glycémie','boh','urée','pH sanguin','interprétation'],summary:'Interpréter par catégorie et stade physiologique, en tenant compte du nombre de sujets et de la cohérence du lot.',sections:[['Énergie',['Croiser glycémie, BOH, NEC et stade physiologique.']],['Azote',['Croiser l’urémie avec la ration, les fourrages et les observations digestives.']],['Prudence',['Les valeurs hors cible orientent une piste de travail ; elles ne constituent pas un diagnostic.']]]},
  {id:'bouses-aspect',theme:'Bouses',title:'Aspect et types de bouses',tags:['bouses','molles','liquides','moulées','dures','mucus'],summary:'Décrire plusieurs caractères si nécessaire : consistance, adhérence, mucus, fibres ou grains.',sections:[['Choix possibles',['Dures, moulées, molles, liquides.','Collantes, avec mucus.','Fibres longues ou grains visibles.']],['Lecture',['Observer le lot plutôt qu’une seule bouse.','Mettre en relation avec la ration, le tamis, le rumen et les fourrages.']]],visual:true},
  {id:'bouses-ph-redox',theme:'Bouses',title:'pH et redox des bouses',tags:['bouses','pH','redox','digestion'],summary:'Mesurer sur un échantillon représentatif et interpréter avec l’aspect visuel et le tamis.',sections:[['Mesure',['Homogénéiser l’échantillon si le protocole le prévoit.','Mesurer rapidement avec une sonde propre.']],['Croisements',['Aspect des bouses.','Structure de la ration.','Qualité et conservation des fourrages.']]]},
  {id:'tamis-protocole',theme:'Tamis',title:'Tamis à bouses sur mélange de lot',tags:['tamis','bouses','lot','pourcentage'],summary:'Le tamis représente un mélange de lot et n’est pas rattaché à un animal individuel.',sections:[['Préparation',['Préciser la catégorie animale et le nombre d’animaux représentés.','Peser le mélange total.']],['Calcul',['Peser les fractions retenues.','Les pourcentages sont calculés automatiquement à partir du poids total.']],['Lecture',['Comparer la répartition des fractions avec l’aspect des bouses et la ration.']]],visual:true},
  {id:'lait-mesures',theme:'Lait',title:'Mesures sur le lait',tags:['lait','pH','brix','densité'],summary:'Noter le contexte du prélèvement et conserver une méthode identique entre les visites.',sections:[['Contexte',['Catégorie ou stade de lactation.','Moment du prélèvement.','Échantillon individuel ou mélange.']],['Mesures',['pH, Brix ou densité selon le protocole retenu.']]]},
  {id:'colostrum-brix',theme:'Colostrum',title:'Qualité du colostrum au réfractomètre',tags:['colostrum','brix','réfractomètre'],summary:'Étalonner le réfractomètre, homogénéiser le colostrum et mesurer à température comparable.',sections:[['Mesure',['Déposer une petite quantité sans bulles.','Lire la valeur Brix.','Nettoyer immédiatement le prisme.']],['Traçabilité',['Noter l’animal, le délai après vêlage et les conditions de conservation.']]]},
  {id:'physique-nec',theme:'Observations physiques',title:'NEC, muscles et remplissage du rumen',tags:['nec','muscles','rumen','observation'],summary:'Utiliser une échelle reproductible et observer plusieurs animaux du même lot.',sections:[['NEC',['Saisir une valeur numérique.','Comparer la moyenne et la dispersion du lot.']],['Muscles',['Échelle : --, -, 0, +, ++.']],['Rumen',['Noter le remplissage de 1 à 5 et le mettre en relation avec l’ingestion.']]],visual:true},
  {id:'physique-poils-membres',theme:'Observations physiques',title:'Poils, aplombs et membres',tags:['poils','aplombs','panard','cagneux','boiterie'],summary:'Plusieurs observations peuvent être sélectionnées pour un même animal.',sections:[['Poils',['Fins, soyeux, piqués, hirsutes, pelucheux, en mue, ternes.']],['Membres',['Blessures, panards, cagneux, coudés, boiterie, inflammation.','Ajouter le score locomotion lorsque pertinent.']]],visual:true},
  {id:'silo-mesure',theme:'Silos',title:'Mesures et description d’un silo',tags:['silo','ensilage','pH','redox','matière sèche'],summary:'Créer un relevé par silo ou front d’attaque et décrire à la fois les mesures et la réalisation de l’ensilage.',sections:[['Mesures',['pH, redox, matière sèche.']],['Réalisation',['Épié ou non épié.','Heure et hauteur de fauche.','Conditionneur, conservateur, double bâche.']],['Stockage',['Tassement, bâchage, état du front et distribution.']]]},
  {id:'sol-mesure',theme:'Sol',title:'Mesure du sol',tags:['sol','pH','redox','argileux','limoneux'],summary:'Identifier la parcelle et le type de sol avant d’enregistrer les valeurs.',sections:[['Type de sol',['Argileux, limoneux, sableux, argilo-limoneux, calcaire, hydromorphe ou autre.']],['Contexte',['Humidité, météo récente, profondeur et conditions de mesure.']],['Mesures',['pH et redox.']]]},
  {id:'plantes-mesure',theme:'Plantes',title:'Mesures plantes / herbe',tags:['plantes','herbe','météo','brix','redox','potassium','nitrates'],summary:'La météo et l’heure de mesure doivent accompagner les résultats pour permettre une comparaison pertinente.',sections:[['Contexte',['Parcelle ou zone.','Météo en choix multiples.','Heure, hauteur d’herbe et temps de pâturage.']],['Mesures',['Brix, redox, pH, potassium, calcium, nitrates et sodium.']],['Conduite',['Fertilisation et mode d’utilisation de la parcelle.']]]},
  {id:'eau-qualite',theme:'Eau',title:'Qualité de l’eau',tags:['eau','pH','redox','conductivité','nitrates'],summary:'Préciser l’origine et le point de prélèvement avant de mesurer.',sections:[['Origines',['Réseau, source, forage, puits, pluie, mixte ou autre.']],['Mesures',['Température, pH, redox, conductivité et nitrates.']],['Interprétation',['Croiser la qualité de l’eau avec le débit, l’accessibilité et les observations animales.']]]},
  {id:'abreuvoir-fiche',theme:'Abreuvoirs',title:'Contrôle d’un abreuvoir',tags:['abreuvoir','débit','hauteur','pipette','palette','matériau'],summary:'Chaque abreuvoir est un point d’eau unique et possède une fiche permanente et des mesures de visite.',sections:[['Identification',['Type : bac, bol, niveau constant, palette, pipette, chauffant ou autre.','Matériau : inox, plastique, béton, fonte, acier galvanisé ou composite.']],['Contrôles',['Débit, hauteur, profondeur, température, propreté, accessibilité, fuite et concurrence.']],['Lien plan',['L’objet placé sur le plan renvoie vers la même fiche, sans double saisie.']]]},
  {id:'electricite-protocole',theme:'Électricité',title:'Mesure des courants parasites',tags:['courant','électricité','multimètre','ac','dc'],summary:'Repérer précisément l’équipement et les conditions de mesure pour pouvoir reproduire le contrôle.',sections:[['Préparation',['Vérifier le multimètre, les cordons et le calibre.','Noter AC ou DC et l’unité.']],['Points possibles',['Abreuvoir, cornadis, barrière, auge, logette ou autre équipement.']],['Après correction',['Lorsque des travaux sont réalisés, noter la valeur avant et après correction.']]]},
  {id:'litiere-controle',theme:'Litière',title:'Contrôle de la litière et du paillage',tags:['litière','pH','redox','température','paillage'],summary:'Créer un relevé par zone ou lot et décrire les pratiques d’entretien.',sections:[['Mesures',['pH, redox, température, humidité, épaisseur et vibration.']],['Entretien',['Type et quantité de matière ajoutée.','Fréquence de paillage et de curage.','Nettoyage et désinfection.']],['Observation',['Failles, glissance, confort et zones humides.']]]},
  {id:'ambiance-controle',theme:'Ambiance',title:'Ambiance du bâtiment',tags:['ambiance','ventilation','température','humidité','ammoniac'],summary:'Décrire les conditions le jour de la visite et la circulation de l’air.',sections:[['Mesures',['Température, hygrométrie, CO₂ ou NH₃ si disponibles.']],['Observations',['Condensation, odeurs, courants d’air, luminosité, bruit.']],['Plan',['Les ventilateurs, rideaux et zones peuvent être représentés sur le plan.']]]},
  {id:'plan-utilisation',theme:'Plan bâtiment',title:'Dessiner et utiliser le plan bâtiment',tags:['plan','rectangle','cornadis','zone','objet'],summary:'Commencer par les dimensions du bâtiment, puis ajouter les équipements et les zones.',sections:[['Démarrage',['Renseigner longueur et largeur pour créer le contour.','Utiliser le rectangle complet comme base.']],['Objets',['Cornadis, barrières, passages d’homme, abreuvoirs, ventilateurs et attaches.']],['Zones',['Aire paillée, couloir d’alimentation, aire d’exercice ou zone personnalisée.']],['Ergonomie',['Les blocs d’outils sont repliables sur téléphone.','Utiliser Ajuster pour afficher tout le bâtiment.']]]},
  {id:'prelevements-base',theme:'Prélèvements',title:'Règles communes de prélèvement',tags:['prélèvement','échantillon','traçabilité'],summary:'Une bonne interprétation dépend d’un prélèvement identifiable, propre et représentatif.',sections:[['Traçabilité',['Sujet ou lot.','Date et heure.','Catégorie ou contexte.']],['Qualité',['Matériel propre.','Éviter les contaminations.','Mesurer rapidement les paramètres sensibles.']]]},
  {id:'etalonnage-general',theme:'Étalonnage',title:'Principes d’étalonnage des appareils',tags:['étalonnage','calibration','solution tampon'],summary:'Suivre la notice de l’appareil et tracer l’étalonnage avant la série de mesures.',sections:[['Avant',['Solutions propres, non périmées et à température adaptée.','Sonde rincée puis égouttée sans frotter.']],['Pendant',['Respecter les points d’étalonnage demandés.','Attendre la stabilisation.']],['Après',['Rincer, stocker correctement et noter toute anomalie.']]]},
  {id:'refractometre',theme:'Réfractomètre',title:'Réfractomètre Brix / densité',tags:['réfractomètre','brix','densité','étalonnage'],summary:'Étalonner à l’eau appropriée, déposer l’échantillon sans bulles et nettoyer le prisme après chaque lecture.',sections:[['Étalonnage',['Nettoyer le prisme.','Déposer l’eau d’étalonnage.','Ajuster à zéro selon le modèle.']],['Mesure',['Déposer une fine couche homogène.','Fermer le volet et lire.']],['Nettoyage',['Essuyer sans rayer puis sécher.']]]},
  {id:'phmetre',theme:'pH-mètre',title:'pH-mètre : étalonnage et mesure',tags:['pH-mètre','pH','sonde','tampon'],summary:'L’état de la sonde et l’étalonnage conditionnent la fiabilité de la mesure.',sections:[['Étalonnage',['Utiliser les tampons prévus par le fabricant.','Rincer entre chaque tampon.']],['Mesure',['Immerger suffisamment la sonde.','Attendre la stabilisation.']],['Stockage',['Ne pas laisser sécher une électrode nécessitant une solution de stockage.']]]},
  {id:'laquatwin',theme:'Laquatwin',title:'Laquatwin pH / conductivité',tags:['laquatwin','pH','conductivité'],summary:'Déposer le volume requis sur le capteur, attendre la stabilisation puis rincer soigneusement.',sections:[['Capteur',['Vérifier qu’il est propre et intact.']],['Étalonnage',['Utiliser les solutions prévues pour le modèle.']],['Mesure',['Déposer l’échantillon sans déborder.','Rincer puis sécher délicatement.']]]},
  {id:'lecteur-glucose-boh',theme:'Lecteur glycémie/BOH',title:'Lecteur glycémie et BOH : erreurs et entretien',tags:['glycémie','boh','erreur','bandelette'],summary:'Les messages d’erreur doivent être notés et vérifiés avant de répéter une mesure.',sections:[['À vérifier',['Type de bandelette.','Quantité de sang.','Température et stockage.','Pile et propreté du lecteur.']],['Répétition',['Utiliser une nouvelle bandelette.','Comparer avec le contexte clinique et le lot.']]]},
  {id:'alimentation-ration',theme:'Alimentation',title:'Décrire une ration par catégorie',tags:['ration','aliment','quantité','distribution'],summary:'Créer une ligne par aliment et par catégorie animale, puis renseigner quantité et mode de distribution.',sections:[['Aliments',['Ensilage, enrubannage, foin, regain, paille, concentré, correcteur, minéral, sel, bicarbonate ou autre.']],['Distribution',['Mélangeuse, râtelier, cornadis, DAC, robot, libre-service, manuel ou pâturage.']],['Compléments',['Ordre de chargement, fréquence, transition, accès au sel et minéralisation.']]]},
  {id:'fourrages-conduite',theme:'Fourrages',title:'Production, récolte et stockage des fourrages',tags:['foin','ensilage','enrubannage','récolte','stockage'],summary:'Décrire les pratiques de culture, récolte, conservation et distribution.',sections:[['Prairies',['Permanente ou temporaire.','Espèces semées et sur-semis.']],['Foin',['Stade, hauteur de coupe, fanage, andainage, balles et séchage.']],['Ensilage / enrubannage',['Conditionnement, conservateur, tassement, bâchage et stockage.']]]},
  {id:'audit-mode',theme:'Audit global',title:'Utiliser le questionnaire d’audit',tags:['audit','questionnaire','frise','documents'],summary:'Ouvrir uniquement les thèmes nécessaires, utiliser les réponses préenregistrées et compléter les commentaires utiles.',sections:[['Questionnaire',['Les chapitres sont repliés par défaut.','Les tableaux dédiés évitent les questions redondantes.']],['Frises',['Deux frises sur 18 mois décrivent la conduite de l’élevage et des cultures.']],['Documents',['Guide complet vierge, analyses seules, audit seul et audit renseigné.']]]},
  {id:'methode-5mvet',theme:'Méthode 5mVet',title:'Lecture globale 5mVet',tags:['5mvet','méthode','analyse','croisement'],summary:'Observer, mesurer, regrouper les informations, formuler des pistes et proposer des vérifications.',sections:[['Démarche',['Observer le troupeau et son environnement.','Regrouper les résultats par catégorie.','Croiser animaux, ration, eau, fourrages et bâtiment.']],['Restitution',['Présenter les constats, les éléments convergents, les limites et les actions à discuter.']],['Prudence',['L’outil accompagne le raisonnement du technicien et ne remplace pas son jugement.']]]}
];

const libraryThemeAliases = {
  'Physique':'Observations physiques', 'Tamis à bouses':'Tamis', 'Silos / ensilages':'Silos', 'Plantes / herbe':'Plantes',
  'Eau / abreuvoirs':'Abreuvoirs', 'Courants électriques':'Électricité'
};

function libraryCard(entry) {
  const sections=(entry.sections||[]).map(([title,items])=>`<div class="library-card-section"><h4>${escapeHtml(title)}</h4><ul>${items.map(x=>`<li>${escapeHtml(x)}</li>`).join('')}</ul></div>`).join('');
  const visual=entry.visual?`<button class="btn small secondary" data-open-visual>Voir la planche visuelle</button>`:'';
  return `<article class="library-card" data-library-entry="${entry.id}"><div class="library-card-head"><div><span class="library-theme-pill">${escapeHtml(entry.theme)}</span><h3>${escapeHtml(entry.title)}</h3></div>${visual}</div><p>${escapeHtml(entry.summary)}</p><div class="library-card-body">${sections}</div></article>`;
}

function renderLibrary() {
  const allThemes=['all',...new Set(libraryEntries.map(x=>x.theme))];
  const query=(librarySearch||'').trim().toLowerCase();
  const selected=activeLibraryTheme==='all'?'all':(libraryThemeAliases[activeLibraryTheme]||activeLibraryTheme);
  const filtered=libraryEntries.filter(entry=>{
    const themeOk=selected==='all'||entry.theme===selected;
    const hay=[entry.title,entry.theme,entry.summary,...(entry.tags||[]),...(entry.sections||[]).flatMap(x=>[x[0],...(x[1]||[])])].join(' ').toLowerCase();
    return themeOk&&(!query||hay.includes(query));
  });
  app.innerHTML=`<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Fiches intégrées, classées par thème et disponibles hors connexion.</div></div><span class="badge autosave">v11.2</span></div>
  <section class="card library-toolbar"><div class="field no-margin"><label>Rechercher</label><input id="library-search" value="${escapeHtml(librarySearch)}" placeholder="Ex. redox, BOH, abreuvoir, étalonnage…"></div><button class="btn secondary" id="library-reset">Tout afficher</button></section>
  <div class="library-layout"><aside class="library-sidebar"><button class="library-theme ${selected==='all'?'active':''}" data-library-theme="all">📚 Toutes les fiches <span>${libraryEntries.length}</span></button>${libraryGroups.map(group=>`<details open><summary>${group.icon} ${escapeHtml(group.label)}</summary>${group.themes.map(theme=>{const count=libraryEntries.filter(x=>x.theme===theme).length;return count?`<button class="library-theme ${selected===theme?'active':''}" data-library-theme="${escapeHtml(theme)}">${escapeHtml(theme)} <span>${count}</span></button>`:''}).join('')}</details>`).join('')}</aside><section class="library-results"><div class="library-result-head"><strong>${filtered.length} fiche(s)</strong><span>${selected==='all'?'Tous les thèmes':escapeHtml(selected)}</span></div>${filtered.length?filtered.map(libraryCard).join(''):'<div class="empty">Aucune fiche ne correspond à cette recherche.</div>'}<section class="card library-documents"><h3>Documents complets</h3><p class="muted">Ces documents sont disponibles séparément. Les fiches ci-dessus restent consultables sans les ouvrir.</p><div class="actions wrap"><a class="btn secondary" href="docs/guide-mesures-base.pdf" target="_blank" rel="noopener">Guide des mesures de base</a><a class="btn secondary" href="docs/fiches-techniques.pdf" target="_blank" rel="noopener">Fiches techniques complètes</a><a class="btn secondary" href="docs/grille-audit-bovin-allaitant.pdf" target="_blank" rel="noopener">Grille d’audit bovin allaitant</a></div></section></section></div>`;
  document.getElementById('library-search')?.addEventListener('input',e=>{librarySearch=e.target.value;renderLibrary()});
  document.getElementById('library-reset')?.addEventListener('click',()=>{activeLibraryTheme='all';librarySearch='';localStorage.setItem('audit-bovin-library-theme','all');renderLibrary()});
  app.querySelectorAll('[data-library-theme]').forEach(btn=>btn.onclick=()=>{activeLibraryTheme=btn.dataset.libraryTheme;librarySearch='';localStorage.setItem('audit-bovin-library-theme',activeLibraryTheme);renderLibrary()});
  app.querySelectorAll('[data-open-visual]').forEach(btn=>btn.onclick=()=>openVisualReference());
}

function openVisualReference(){
  const overlay=document.createElement('div');overlay.className='visual-overlay';overlay.innerHTML=`<div class="visual-panel"><button class="visual-close" aria-label="Fermer">×</button><img src="docs/reference-visuelle.png" alt="Planche visuelle : rumen, aplombs, types de bouses et couleurs des urines"></div>`;document.body.appendChild(overlay);const close=()=>overlay.remove();overlay.querySelector('.visual-close').onclick=close;overlay.onclick=e=>{if(e.target===overlay)close()};document.addEventListener('keydown',function esc(e){if(e.key==='Escape'){close();document.removeEventListener('keydown',esc)}});
}

function openLibraryTheme(theme){activeLibraryTheme=libraryThemeAliases[theme]||theme;librarySearch='';localStorage.setItem('audit-bovin-library-theme',activeLibraryTheme);currentView='library';document.querySelectorAll('.nav-btn').forEach(b=>b.classList.toggle('active',b.dataset.view==='library'));renderLibrary();window.scrollTo({top:0,behavior:'smooth'});}
...
function render() {
  const renderers = { dashboard: renderDashboard, farms: renderFarms, visits: renderVisits, animals: renderAnimals, analysis: renderAnalysis, feeding: renderFeeding, building: renderBuilding, audit: renderAuditGlobal, library: renderLibrary, backup: renderBackup };
  app.innerHTML = '';
...
function renderNumericSection(visit) {
  ...
  <div class="family-tabs-row"><nav class="family-tabs">${families.map(f=>`<button class="family-tab ${activeAnalysisFamily===f?'active':''}" data-analysis-family="${f}">${f}</button>`).join('')}</nav><button class="btn secondary library-context-btn" data-open-library-theme="${escapeHtml(activeAnalysisFamily)}">ℹ Fiches ${escapeHtml(activeAnalysisFamily)}</button></div>
...
function renderFeeding() {
  ...
  app.innerHTML = `
    <div class="section-title"><div><h2>Alimentation</h2><div class="muted">Rations par catégorie, distribution, minéralisation et transitions.</div></div><div class="actions"><button class="btn secondary" data-open-library-theme="Alimentation">ℹ Fiches</button><span class="badge autosave">Sauvegarde automatique</span></div></div>
    ${activeVisitBanner(visit)}
...
function renderBuilding() {
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Bâtiment</h2><div class="muted">Données permanentes, mesures de visite et plan interactif.</div></div><div class="actions"><button class="btn secondary" data-open-library-theme="Plan bâtiment">ℹ Fiches</button><span class="badge autosave">Sauvegarde automatique</span></div></div>
  ${activeVisitBanner(visit)}
  ${!visit?'<section class="empty">Choisissez une visite dans l’onglet Visites.</section>':`
