...
// Cette fonction manquait dans la v14.6.21.95 et provoquait l'erreur splitUsefulLines is not defined.
...
// v14.6.21.95 — Audits ciblés + motif libre + orientation syndromique veaux
...
function renderPlanches() {
  ...
  app.innerHTML = `<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Repères visuels, fiches pratiques et carnet technique, disponibles hors ligne.</div></div><span class="badge autosave">v14.6.21.95</span></div>
...
function renderJournalSuivi(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📒 Journal & points de vigilance</h2><div class="muted">Noter les nouvelles reçues entre deux visites, les difficultés et les événements sanitaires.</div></div><span class="badge autosave">v14.6.21.95</span></div>
...
function renderVisits() {
  ...
  app.innerHTML = `
    <div class="section-title"><div><h2>Visites</h2><div class="muted">Toutes les visites enregistrées restent accessibles, y compris les plus anciennes.</div></div><span class="badge autosave">v14.6.21.95</span></div>
...
function renderFarmerQuestionnaires(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📨 Questionnaires éleveur</h2><div class="muted">Préparer la visite puis récupérer uniquement les réponses encore manquantes.</div></div><span class="badge autosave">v14.6.21.95</span></div>${activeVisitBanner(visit)}
...
function renderPilotageActions(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>🎯 Pilotage des actions</h2><div class="muted">Vue commune de toutes les actions décidées lors des visites.</div></div><span class="badge autosave">v14.6.21.95</span></div>
...
function renderNutritionAnalysis(){
  const visit=activeVisit();
  if(!visit){app.innerHTML=`<div class="section-title"><div><h2>Analyse nutritionnelle</h2><div class="muted">Interprétation simple des analyses de fourrage et de ration.</div></div><span class="badge autosave">v14.6.21.95</span></div><section class="empty">Choisissez une visite dans l’onglet Visites.</section>`;return;}
  visit.feeding=visit.feeding&&typeof visit.feeding==='object'?visit.feeding:{rations:[],settings:{},history:[]};
  visit.feeding.nutrition=visit.feeding.nutrition&&typeof visit.feeding.nutrition==='object'?visit.feeding.nutrition:{};
...
function renderFollowup(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Historique & évolution</h2><div class="muted">Comparer deux visites d’une même exploitation : reproduction, mortalité, mesures, alimentation, bâtiment et plans d’action.</div></div><span class="badge autosave">v14.6.21.95</span></div>
...
function fullReportStyles(){return `${printBaseStyles()} body{max-width:980px;margin:0 auto;padding:20px;background:#fff;color:#16231c;font-size:10.5pt;line-height:1.35}.report-cover{padding:24px;border:2px solid #b53670;border-radius:16px;margin-bottom:24px}.report-brand{display:flex;gap:18px;align-items:center}.report-logo{width:72px;height:72px;border-radius:18px;background:#b53670;color:white;display:grid;place-items:center;text-align:center;font-weight:800}.report-cover h1{margin:0}.report-cover-grid,.report-kpis{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-top:20px}.report-cover-grid>div,.report-kpis>div{padding:10px;background:#fff4f8;border-radius:8px}.report-cover-grid span,.report-kpis span{display:block;color:#66756c;font-size:9.5pt}.report-cover-grid strong,.report-kpis strong{display:block;margin-top:3px}.report-section{margin:22px 0;break-inside:auto}.report-summary-grid,.report-columns,.herd-chart-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.report-box,.report-reason,.herd-chart-card{border:1px solid #cfdad3;border-radius:10px;padding:12px;margin:10px 0;break-inside:avoid-page}.report-subsection{border:1px solid #cfdad3;border-radius:10px;padding:12px;margin:10px 0;break-inside:auto}.report-box.positive{border-left:6px solid #b53670}.report-box.warning{border-left:6px solid #e0a326}.report-empty{color:#6b746e;font-style:italic}.report-footer{margin-top:30px;border-top:2px solid #d5dfd8;padding-top:16px}.signature-grid{display:grid;grid-template-columns:1fr 1fr;gap:30px;margin-top:25px}.signature-grid>div{min-height:90px;border:1px solid #aab5ad;padding:12px}.report-photo-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.report-photo-grid figure{margin:0;break-inside:avoid;border:1px solid #cfdad3;border-radius:10px;padding:8px}.report-photo-grid img{width:100%;max-height:360px;object-fit:contain}.report-photo-grid figcaption{padding:7px 2px;font-size:10pt}.herd-chart-grid{grid-template-columns:1fr}.herd-chart-card{break-inside:avoid;background:#fffafd;padding:8px}.herd-svg-chart{width:100%;max-width:650px;height:auto;display:block;margin:0 auto}.repro-age-donut-svg{width:100%;max-width:285px;height:auto}.annual-history-table td.annual-trend-good{color:#15803d!important;font-weight:800!important;background:#eefbf2!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}.annual-history-table td.annual-trend-bad{color:#b91c1c!important;font-weight:800!important;background:#fff0f0!important;-webkit-print-color-adjust:exact;print-color-adjust:exact}.herd-chart-legend{display:flex;gap:12px;flex-wrap:wrap;margin:6px 0 10px}.herd-chart-legend span{display:inline-flex;align-items:center;gap:6px;font-size:10pt;color:#425047}.herd-chart-legend i{width:12px;height:12px;border-radius:3px;display:inline-block}.legend-square{font-size:15pt;line-height:1}.report-color-legend{display:flex;gap:8px;flex-wrap:wrap;margin:8px 0 12px}.report-color-legend span{padding:5px 9px;border:1px solid #b8c4bd;border-radius:6px;font-weight:700}.report-value-green{background:#dff3e7!important;color:#174d2e!important}.report-value-yellow{background:#fff0b8!important;color:#6b5300!important}.report-value-red{background:#ffd5d2!important;color:#7d1b17!important}.report-wide-table{overflow:visible}.report-wide-table table{font-size:8.5pt}.abnormal-subjects{margin:10px 0;padding:9px 11px;border-left:4px solid #d14d49;background:#fff5f4}.abnormal-subjects>div{display:flex;gap:8px;flex-wrap:wrap;margin-top:4px}.abnormal-subjects span{color:#5e4a4a}.page-break{page-break-before:always}.report-penalty-hit{background:#fff1c7!important;border-radius:6px;font-weight:800!important}.report-penalty-hit.severe{background:#ffd8d5!important;color:#a01818!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}.report-days-warning{background:#fff0c7!important;color:#9a6700!important;font-weight:800!important}.report-days-danger{background:#ffd9d6!important;color:#a01818!important;font-weight:800!important}.score-ok{color:#176238!important;background:#dff3e6!important;font-weight:800!important}.score-warn{color:#9a6700!important;background:#fff0c7!important;font-weight:800!important}.score-bad{color:#a01818!important;background:#ffd9d6!important;font-weight:800!important}.repro-score-hit-row td{background:#fff4d5}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}@media print{h1,h2,h3,h4,h5{break-after:avoid-page!important;page-break-after:avoid!important}p,li{orphans:3;widows:3}thead{display:table-header-group}tr{break-inside:avoid-page;page-break-inside:avoid}.report-box,.report-reason,.herd-chart-card,.decision-alert,.decision-theme{break-inside:avoid-page;page-break-inside:avoid}.report-subsection{break-inside:auto;page-break-inside:auto}.herd-chart-legend .legend-square{display:inline!important}.report-value-green,.report-value-yellow,.report-value-red{box-shadow:inset 0 0 0 1000px currentColor 0!important}}@media(max-width:700px){.report-cover-grid,.report-kpis,.report-summary-grid,.report-columns,.repro-age-overview.grouped{grid-template-columns:1fr}}`}
...
// v14.6.21.95 — aide à la décision transversale : priorités, tendances et références internes.
...
// v14.6.21.95 — cohérence pré-visite, tableau global mouvements/renouvellement et âges lisibles.
...
// v14.6.21.95 — « fabrique du troupeau » : naissance femelles → conservation jusqu’à la reproduction → 1er vêlage → réforme.
...
// v14.6.21.95 — estimation économique pré-visite, calculée uniquement sur les données déjà disponibles.
...
// v14.6.21.95 — check-up, suivi d'étude, économie et conservation globale du défilement horizontal
...
// v14.6.21.95 — suivi du temps par intervenant + temps GDS préparation/terrain/compte rendu/suivi

// v14.6.21.95 — questionnaires persistants, repères de saisie, bilan sanitaire/éco partenaire, supports papier, check-up responsive.

window.addEventListener('DOMContentLoaded',()=>{initGlobalSearch();initAccordionMemory();});
// v14.6.21.95 — cohérence, imprimables préparation, animaux présents, recherche globale.
