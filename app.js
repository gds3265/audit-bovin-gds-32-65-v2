...
const plancheGroups = [
  ...
  { id:'memos', icon:'🧠', title:'Mémos visuels', subtitle:'Aplombs, SRR par période et note d’état corporel.' },
...
function plancheContent(id) {
  ...
  if (id === 'memos') return `
    <section class="card planche-main"><h3>🧠 Mémos visuels terrain</h3>
      <p class="muted">Cliquez sur une image pour l’agrandir. Ces mémos restent disponibles hors ligne.</p>
      <div class="memo-grid">
      ...
      <div class="planche-note"><strong>Important :</strong> utilisez ces planches comme aide visuelle et conservez la méthode de notation retenue de façon homogène entre les visites.</div>
    </section>`;
  return `
...
function renderPlanches() {
  ...
  app.innerHTML = `<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Repères visuels, fiches pratiques et carnet technique, disponibles hors ligne.</div></div><span class="badge autosave">v14.6.18</span></div>
    <div class="planche-layout">
      ...
      <div class="planche-content">${plancheContent(selected.id)}${libraryNotebookHtml()}</div>
    </div>`;
...
function renderJournalSuivi(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📒 Journal & points de vigilance</h2><div class="muted">Noter les nouvelles reçues entre deux visites, les difficultés et les événements sanitaires.</div></div><span class="badge autosave">v14.6.18</span></div>
...
function renderVisits() {
  ...
  app.innerHTML = `
    <div class="section-title"><div><h2>Visites</h2><div class="muted">Toutes les visites enregistrées restent accessibles, y compris les plus anciennes.</div></div><span class="badge autosave">v14.6.18</span></div>
...
function renderPilotageActions(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>🎯 Pilotage des actions</h2><div class="muted">Vue commune de toutes les actions décidées lors des visites.</div></div><span class="badge autosave">v14.6.18</span></div>
...
function renderNutritionAnalysis(){
  const visit=activeVisit();
  if(!visit){app.innerHTML=`<div class="section-title"><div><h2>Analyse nutritionnelle</h2><div class="muted">Interprétation simple des analyses de fourrage et de ration.</div></div><span class="badge autosave">v14.6.18</span></div><section class="empty">Choisissez une visite dans l’onglet Visites.</section>`;return;}
...
function renderFollowup(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Historique & évolution</h2><div class="muted">Comparer deux visites d’une même exploitation : reproduction, mortalité, mesures, alimentation, bâtiment et plans d’action.</div></div><span class="badge autosave">v14.6.18</span></div>
