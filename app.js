...
function renderPlanches() {
  ...
  app.innerHTML = `<div class="section-title"><div><h2>Bibliothèque technique</h2><div class="muted">Quelques repères visuels utiles, intégrés à l’application et disponibles hors ligne.</div></div><span class="badge autosave">v14.2</span></div>
...
function renderAssistantGDS(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>Analyse & interprétation</h2><div class="muted">Synthèse professionnelle des données de la visite active.</div></div><span class="badge autosave">v14.2 Professional</span></div>${activeVisitBanner(visit)}
...
function renderJournalSuivi(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>📒 Journal & points de vigilance</h2><div class="muted">Noter les nouvelles reçues entre deux visites, les difficultés et les événements sanitaires.</div></div><span class="badge autosave">v14.2</span></div>
...
function renderPilotageActions(){
  ...
  app.innerHTML=`<div class="section-title"><div><h2>🎯 Pilotage des actions</h2><div class="muted">Vue commune de toutes les actions décidées lors des visites.</div></div><span class="badge autosave">v14.2</span></div>
...
async function exportPartnerWorkbook(visit,phase='auto'){
  ...
  let response=await fetch('./modele-partenaires-passage-bv.xlsx?v=14.2',{cache:'no-store'});if(!response.ok)response=await fetch('./modele-partenaires-passage-bv.xlsx',{cache:'reload'});if(!response.ok)throw new Error('Modèle partenaire introuvable');
